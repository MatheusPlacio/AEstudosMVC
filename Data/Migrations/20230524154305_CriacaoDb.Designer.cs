...
namespace Data.Migrations
{
    ...
    [Migration("20230524154305_CriacaoDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Aluguel", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Apartamento", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Funcao", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "406c6d52-9c27-4f97-b835-f383002fdb4b",
                        ...
                        new
                        {
                            Id = "b269ba9c-d4e4-4d0f-837f-c48f5d9364a1",
                        ...
                        new
                        {
                            Id = "6fd49b74-0bfb-4496-a8b9-9bcc500ee0fc",
            ...
            modelBuilder.Entity("Domain.Models.HistoricoRecurso", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Mes", b =>
                {
                    b.Property<int>("MesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.ServicoPredio", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Aluguel", b =>
                {
                    b.HasOne("Domain.Models.Mes", "Mes")
                        .WithMany("Alugueis")
                        .HasForeignKey("MesId")
            ...
            modelBuilder.Entity("Domain.Models.Apartamento", b =>
                {
                    b.HasOne("Domain.Models.Usuario", "Morador")
                        .WithMany("MoradoresApartamentos")
                        .HasForeignKey("MoradorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Models.Usuario", "Proprietario")
            ...
            modelBuilder.Entity("Domain.Models.Pagamento", b =>
                {
                    b.HasOne("Domain.Models.Aluguel", "Aluguel")
                        .WithMany("Pagamentos")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Domain.Models.Funcao", null)
                        .WithMany()
